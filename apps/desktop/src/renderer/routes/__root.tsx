...
import { WorkspaceSidebar, type WorkspaceSidebarView } from "../components/workspace-sidebar";
...
function RootRoute(): ReactElement {
  ...
  const [leftSidebarWidth, setLeftSidebarWidth] = useState(SIDEBAR_DEFAULT_WIDTH);
  const [activeView, setActiveView] = useState<WorkspaceSidebarView>("workspace");
  ...
  return (
    <WorkspaceShellLayout
      ...
      titlebarCenter={<span className="text-xs text-muted-foreground">Workspace</span>}
      sidePaneHeader={null}
      leftSidebar={
        <WorkspaceSidebar
          ...
          onSelectKnowledgeBase={() => setActiveView("knowledge-base")}
          onSelectGlobalChat={() => setActiveView("global-chat")}
